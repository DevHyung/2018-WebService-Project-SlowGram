...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="./userinfo.php" class="logo">
      ...
      <span class="logo-lg"><b>RSK</b>-ADMIN</span>
    </a>
                ...
                <tbody>
                  <?php
                    while($row=mysqli_fetch_array($query))
                    {
                      ...
                      <td>'.$row['isApproval'].'</td>';
                      if($row['isApproval']=='n'){
                      echo'
                      <td><button onclick="test(\''.$row['username'].'\','.$row['idx'].')"class="btn btn-primary btn-sm">승인</button></td>
                      </tr>
                      ';
                      }
                      else{
...
function test(name,idx) {
      //var s = getCmaFileInfo(obj,stype);
      //alert(snum+"gd");
      window.open("../../../DB/verify_yes.php?idx="+idx+"&username="+name, "_blank", "left=300,width=10,height=10");
      alert('변경되었습니다');
      setTimeout(function () {
